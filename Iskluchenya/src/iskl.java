...
public class iskl {
    public static void main(String[] args) {
        ...
        System.out.println("Enter your data(SurnameName MiddleName DateOfBirth PhoneNumber Gender):");
        String input = scanner.nextLine();
        scanner.close();
        try {
            String[] parts = input.split("");
            if (parts.length != 6) {
                throw new IllegalArgumentException("Invalid number of arguments.Expected6.");
            }
    ...
    private static void writeToFile(String surname, String name, String middleName, LocalDate dateOfBirth, long phoneNumber, char gender)
            throws IOException {
        String filename = surname + ".txt";//Формированиеимени файла
